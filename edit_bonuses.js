...
const deductionsHtmlMatch = content.match(/\{activeTab === 'deductions' && \([\s\S]*?\)\s*\}/);
if (deductionsHtmlMatch) {
  let bonusesHtml = deductionsHtmlMatch[0]
  ...
  content = content.replace(deductionsHtmlMatch[0], deductionsHtmlMatch[0] + '\\n\\n      ' + bonusesHtml);
}
